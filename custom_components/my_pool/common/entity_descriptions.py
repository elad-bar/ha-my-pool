...
from homeassistant.const import Platform, UnitOfTemperature, UnitOfElectricPotential, UnitOfVolume, \
    UnitOfTime, CONCENTRATION_PARTS_PER_MILLION, EntityCategory
from homeassistant.helpers.entity import EntityDescription

from custom_components.my_pool.common.consts import CONFIG_USER_POWER, CONFIG_USER_COVER_POWER, CONFIG_USER_PH, UNIT_PH, \
    CONFIG_USER_ORP, CONFIG_USER_CL, CONFIG_TECHNICIAN_POOL_SIZE, CONFIG_TECHNICIAN_ACID_PUMP_ENABLE, \
    IS_DEVICE_CONNECTED, RUNTIME_DEVICE_ON, RUNTIME_DEVICE_TURBO, RUNTIME_DEVICE_TURBO_TIME, RUNTIME_PH_VALUE, \
    RUNTIME_ORP_VALUE, RUNTIME_SALINITY_VALUE, RUNTIME_CPU_TEMPERATURE_VALUE, RUNTIME_BOARD_TEMPERATURE_VALUE, \
    RUNTIME_WATER_TEMPERATURE_VALUE, RUNTIME_CELL_TEMPERATURE_VALUE, RUNTIME_ACID_PUMP_DAYS_LEFT, NETWORK_SSID, \
    CONFIG_AUTOMATION_CHANNEL_MODE, CONFIG_AUTOMATION_CHANNEL_STATE, RUNTIME_AUTOMATION_STATE_CHANNEL_TIMELEFT, \
